...
use FreeBet\Bundle\GambleBundle\Exception\UnsupportedBetType;
...
class BetTypeChain
{
     ...
     *
     * @return \FreeBet\Bundle\GambleBundle\BetType\BetTypeInterface
     *
     ...
     *
     * @param \FreeBet\Bundle\GambleBundle\BetType\BetTypeInterface $gamble
     * @param string $type
     * @param int $order
     */
